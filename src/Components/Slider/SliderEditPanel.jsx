...
import { editSlider, getCity, getProvince, getUserByMobile } from "../../Api/Slider";
...
export function SliderEditPanel({ item, cancel, reload }) {
    ...
    const [Slider, setSlider] = useState(item.Slider);
    ...
    async function submit() {
        try {
            let response = await editSlider(postalCode, Slider, no, unit, area, province.id, city.id, users.id, id);
            reload();
