...
import {getCity, getProvince, getUserByMobile, insertTag} from "../../Api/Tag";
...
export function TagInsertPanel({reload}) {
   ...
   async function submit() {
       try {
        let response =await insertTag(postalCode, Tag, no, unit, area, province.id, city.id, users.id);
        reload();
