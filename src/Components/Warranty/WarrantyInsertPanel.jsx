...
import {getCity, getProvince, getUserByMobile, insertWarranty} from "../../Api/Warranty";
...
export function WarrantyInsertPanel({reload}) {
   ...
   async function submit() {
       try {
        let response =await insertWarranty(postalCode, Warranty, no, unit, area, province.id, city.id, users.id);
        reload();
