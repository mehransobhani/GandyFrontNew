...
import { editWarranty, getCity, getProvince, getUserByMobile } from "../../Api/Warranty";
...
export function WarrantyEditPanel({ item, cancel, reload }) {
    ...
    async function submit() {
        try {
            let response = await editWarranty(postalCode, Warranty, no, unit, area, province.id, city.id, users.id, id);
            reload();
