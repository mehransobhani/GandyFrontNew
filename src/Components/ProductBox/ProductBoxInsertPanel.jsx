...
import {getCity, getProvince, getUserByMobile, insertProductBox} from "../../Api/ProductBox";
...
export function ProductBoxInsertPanel({reload}) {
   ...
   async function submit() {
       try {
        let response =await insertProductBox(postalCode, ProductBox, no, unit, area, province.id, city.id, users.id);
        reload();
