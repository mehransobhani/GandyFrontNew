...
import { getBrandByWords, getProductTypeByWords, insertProduct } from "../../Api/Product";
                    ...
                    <div className=" ">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <Select2 change={changeBrandSearchHandle} options={brandSearch} click={setBrand} />
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <Select2 change={changeProductTypeSearchHandle} options={productTypeSearch} click={setProductType} />
