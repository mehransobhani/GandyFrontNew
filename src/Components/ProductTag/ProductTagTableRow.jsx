...
import { removeProductTag } from "../../Api/ProductTag";
import { toast } from "react-toastify";

export function ProductTagTableRow({ editMode, editItem, reload, item }) {
    ...
    async function removeHandle() {
        let response = await removeProductTag(item.id);
        reload();
