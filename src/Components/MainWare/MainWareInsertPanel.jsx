...
import {getCity, getProvince, getUserByMobile, insertMainWare} from "../../Api/MainWare";
...
export function MainWareInsertPanel({reload}) {
    ...
    const [MainWare, setMainWare] = useState("");
   ...
   async function submit() {
       try {
        let response =await insertMainWare(postalCode, MainWare, no, unit, area, province.id, city.id, users.id);
        reload();
